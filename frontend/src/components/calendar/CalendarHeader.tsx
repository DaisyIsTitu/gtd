    ...
    <div className="border-b border-gray-200 bg-white">
      ...
      <div className="flex">
        ...
        {weekDays.map((date, index) => (
          <div key={date.toISOString()} className="flex-1 border-l border-gray-200 first:border-l-0">
            <div className="p-3 text-center">
              ...
              <div className={`
                ...
                ${isToday(date) 
                  ? 'bg-primary-500 text-white rounded-full w-8 h-8 flex items-center justify-center mx-auto' 
                  : 'text-gray-700'
                }
              `}>
                {date.getDate()}
