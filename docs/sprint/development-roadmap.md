...
#### 사용자 경험
- [x] S2.F.9 로딩 스켈레톤 UI
- [x] S2.F.10 기본적인 반응형 디자인
- [x] S2.F.11 에러 상태 표시 (Mock)
...
### Frontend 작업
#### 스케줄링 UI
- [x] S3.F.1 "자동 배치" 버튼 및 프로그레스 표시
- [x] S3.F.2 배치 결과 미리보기 모드
- [x] S3.F.3 배치된 Todo를 캘린더에 표시
- [x] S3.F.4 상태별 시각적 구분 (대기중, 배치됨, 완료)

#### 상태 관리
- [x] S3.F.5 Todo 상태 전환 UI (시작/완료 버튼)
- [x] S3.F.6 필터링 및 정렬 기능 고도화
- [x] S3.F.7 검색 기능 추가
